          ...
          <Row>
            <h1 className="title">
              ...
              <p className="error-msg" style={{ fontSize: "20%" }}>
                Error pages are often viewed by people without a background in
                web-development. These error pages are friendly for all web
                users and also suggest next steps.
              </p>
            </h1>
          </Row>
                    ...
                    <Card className="card-just-text">
                      ...
                      >
                        <CardBody className="text-center">
                          ...
                          <p className="card-description">301</p>
                        </CardBody>
                      </Link>
                    </Card>
                    ...
                    <Card className="card-hover-effect card-just-text">
                      <Link
                        to={{
                          ...
                          state: {
                            code: "401",
                            text: "You aren't authorized to view this site. If you think you should be able to view this site, make sure you are logged in with the right account. If the issue persists, reach out to your admin.",
                    ...
                    <Card className="card-hover-effect card-just-text">
                      <Link
                        to={{
                          ...
                          state: {
                            code: "403",
                            text: "There is no reason for you to be here. Make sure you have the right link.",
