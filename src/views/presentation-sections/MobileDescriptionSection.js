          ...
          <Row>
            <Col className="ml-auto mr-auto" lg="4" md="10">
              <Container className="basic-container">
                <h3 className="title">
                  ...and then learned mobile development fast
                </h3>
                {/* <h6 className="category">The core elements of your website</h6> */}
                <h5 className="description">
                  My mobile app experience started in React Native but also
                  includes Kotlin. Mobile brings added complexity of a small
                  screen, weaker network access and less computational power,
